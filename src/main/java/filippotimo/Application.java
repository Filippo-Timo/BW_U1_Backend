...
//        MezzoPubblico secondoMezzo = new MezzoPubblico("TRAM-1", tipoMezzo.TRAM);
//        MezzoPubblico terzoMezzo = new MezzoPubblico("Iveco 2", tipoMezzo.AUTOBUS);
//
//         md.saveMezzoPubblico(primoMezzo);
//         md.saveMezzoPubblico(secondoMezzo);
//         md.saveMezzoPubblico(terzoMezzo);
//
//
...
//        Biglietto biglietto3 = new Biglietto(LocalDate.of(2026, 1, 17), primoRivenditoreDB, tipoMezzo.AUTOBUS);
//
//         pd.save(biglietto1);
//         pd.save(biglietto2);
//         pd.save(biglietto3);
...
//        td.createAndSaveTratta("Linea B", "Torvaianica", "Tor San Lorenzo", 30);
//
//
...
//        td.createAndSavePercorrenza(22, tratta1DB, primoMezzoDB);
//        td.createAndSavePercorrenza(18, tratta2DB, secondoMezzoDB);
//        td.createAndSavePercorrenza(33, tratta2DB, secondoMezzoDB);
//
//
...
//         md.setDataFineManutenzione(1,LocalDate.of(2026,1,30));
...
//        pd.validateATicketBySetter(3, 1);
        ...
        System.out.println("******************************* VEDERE QUANTI BIGLIETTI E ABBONAMENTI EMESSI PER RIVENDITORE IN UN LASSO DI TEMPO *******************************");

        System.out.println("**Questo metodo restituisce il numero di prodotti**");
        System.out.println(pd.countAllProductsInAPeriodOfTime(1, LocalDate.of(2025, 1, 15), LocalDate.now()));

        System.out.println("**Questo metodo restituisce una lista di prodotti**");
...
//        System.out.println("******************************* IMPOSTARE UN RIVENDITORE AUTOMATICO COME IN SERVIZIO / FUORI SERVIZIO *******************************");

        rd.setInServizioRivenditoreAutomatico(2, false);


        System.out.println("************************************ VERIFICARE VALIDITÀ ABBONAMENTO IN BASE AL NUMERO DI TESSERA  ************************************");

        List<Abbonamento> abbonamentoVerificato = ud.verifyAbbonamentoByTessera(1);
        ...
        System.out.println("************************************ TRACCIARE LE MANUTENZIONI DI UN MEZZO  ************************************");

        List<InManutenzione> listaManutenzioniDiUnMezzo = md.getListaManutenzioniPerMezzoById(3);

        listaManutenzioniDiUnMezzo.forEach(System.out::println);


        System.out.println("************************************ NUMERO DI BIGLIETTI VIDIMATI SU UN MEZZO IN UN PERIODO DI TEMPO ************************************");

        System.out.println("--Ritorna il NUMERO di biglietti vidimati in un determinato lasso di tempo per un determinato mezzo specificato tramite ID--");
        ...
        System.out.println("*************************************** COUNT / FIND NUMERO DI BIGLIETTI VIDIMATI IN UN DETERMINATO LASSO DI TEMPO ***************************************");

        System.out.println("---Ritorna il NUMERO di biglietti vidimati in un determinato lasso di tempo---");
        ...
        System.out.println("---Ritorna la LISTA di biglietti vidimati in un determinato lasso di tempo---");
        ...
        System.out.println("************************************ NUMERO DI PERCORRENZE PER MEZZO E TRATTA ************************************");
        ...
        System.out.println("************************************ LISTA DEI TEMPI DI PERCORRENZA EFFETTIVI PER MEZZO E TRATTA ************************************");
        ...
        System.out.println("************************************ TEMPO MEDIO DI PERCORRENZA EFFETTIVO DI UN MEZZO SU UNA TRATTA ************************************");
